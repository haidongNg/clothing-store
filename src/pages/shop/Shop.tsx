            ...
            <div className="section">
                <div className="container">
                    ...
                    <nav className="pagination is-centered" role="navigation" aria-label="pagination">
                        <a href="#a" className="pagination-previous" title="This is the first page">Previous</a>
                        <a href="#a" className="pagination-next">Next page</a>
                        <ul className="pagination-list">
                            <li>
                                <a href="#a" className="pagination-link is-current" aria-label="Page 1" aria-current="page">1</a>
                            </li>
                            <li>
                                <a href="#a" className="pagination-link" aria-label="Goto page 2">2</a>
                            </li>
                            <li>
                                <a href="#a" className="pagination-link" aria-label="Goto page 3">3</a>
                            </li>
                        </ul>
                    </nav>
                </div>
